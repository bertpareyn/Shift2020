        ...
        <div id="content">
            ...
            <div class="books-container">
                <?php while ( $wp_query->have_posts() ) : the_post(); ?>
                    ...
                    <?php $title = $custom_fields['article_title'][0] ?>
                    <?php $note = $custom_fields['note'][0] ?>
                    <?php $description = $custom_fields['article_description'][0] ?>
                    <?php $cover = wp_get_attachment_image_src($custom_fields['article_cover'][0], 'large')[0] ?>
